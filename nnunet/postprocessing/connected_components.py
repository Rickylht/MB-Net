...
if __name__ == "__main__":
    input_folder = "/workspace/nnUNet-master/nnUNet_testdata/reg_test_10/pre"
    output_folder = "/workspace/nnUNet-master/nnUNet_testdata/reg_test_10/post_processing"
    for_which_classes = []
    for i in range(1,35):
        for_which_classes.append(i)
